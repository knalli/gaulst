...
//		wenn wei§ am zug, dann einfach "normal"
		...
		if(farbe.equals(Farbe.WEISS)){
			if(linie.vorherige() == null)
				throw new NegativePreConditionException("UngŸltiges Feld wurde berechnet: (L) "+linie.toString()+"- mit "+n);
...
//		wenn wei§ am zug, dann einfach "normal"
		...
		if(farbe.equals(Farbe.WEISS)){
			if(reihe.vorherige() == null)
				throw new NegativePreConditionException("UngŸltiges Feld wurde berechnet: (R) "+reihe.toString()+"- mit "+n);
