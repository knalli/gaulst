...
//		wenn wei§ am zug, dann einfach "normal"
		...
		if(farbe.equals(Farbe.WEISS)){
			if(linie.vorherige() == null)
				throw new NegativePreConditionException("UngŸltiges Feld wurde berechnet: "+linie+"-");
...
//		wenn wei§ am zug, dann einfach "normal"
		...
		if(farbe.equals(Farbe.WEISS)){
			if(reihe.vorherige() == null)
				throw new NegativePreConditionException("UngŸltiges Feld wurde berechnet: "+reihe+"-");
